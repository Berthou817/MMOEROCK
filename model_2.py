...
class MMOE(nn.Module):
    def __init__(self):
        ...
        self.experts = nn.ModuleList([Expert() for i in range(3)])
        self.w_gates = nn.ParameterList([nn.Parameter(torch.randn(256*256,3), requires_grad=True) for i in range(2)])
        self.towers = nn.ModuleList([Tower() for i in range(2)])
